  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (!email.trim() || !password) {
      setModalState({
        ...
        message: "Email dan password wajib diisi untuk login.",
        type: "warning",
      ...
      try {
        ...
        if (foundUser) {
          ...
          setModalState({
            ...
            title: "Login Gagal",
            message:
              "Kombinasi email atau password yang Anda masukkan salah.\nSilakan periksa kembali.",
            type: "error",
      ...
      <div className="min-h-screen flex selection:bg-emerald-500 selection:text-white">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center bg-gray-50 p-6 md:p-10 lg:p-12">
          <div className="w-full max-w-md space-y-6 bg-white p-8 md:p-10 rounded-2xl shadow-xl">
            <div className="text-center lg:hidden"></div>
            <h2 className="text-3xl font-bold text-gray-800 text-center lg:text-left tracking-tight">
              Masuk ke Akun Anda
            </h2>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  ...
                  <Link
                    href="#"
                    className="text-xs text-emerald-600 hover:underline hover:text-emerald-700"
                  >
                    Lupa Password?
                  </Link>
                </div>
