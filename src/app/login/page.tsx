   ...
   <div className="min-h-screen flex">
       ...
       <div className="w-1/2 flex flex-col items-center justify-center bg-[rgb(168,213,186)] text-white px-8">
         <div className="text-center">
           ...
           <h1 className="text-5xl font-bold mb-4">Lumora</h1>
           <p className="text-lg">
             Selamat Datang di <span className="font-semibold">Lumora</span>
             <br />
             Tempat Designer Berkumpul dan Berkarya!
           </p>
         </div>
       </div>
       ...
       <div className="w-1/2 flex items-center justify-center bg-white p-12">
         <div className="w-full max-w-xl space-y-6 p-10 rounded">
           ...
           <div className="text-sm text-center">
             Baru di Lumora?{' '}
             <Link href="/register" className="text-[rgb(168,213,186)] font-semibold cursor-pointer hover:underline">
               Daftar
             </Link>
           </div>
         </div>
