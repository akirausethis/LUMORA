...
const RegisterPage = () => {
      ...
      try {
        ...
        if (existingUsers.some((user) => user.username === formData.username)) {
          setModalState({
            ...
            title: "Registrasi Gagal",
            message:
              "Username yang Anda pilih sudah digunakan.\nSilakan pilih username lain.",
            type: "error",
            buttons: [{ text: "Mengerti", onClick: closeGenericModal }],
            onClose: closeGenericModal,
          });
        ...
        setModalState({
          ...
          message:
            "Akun Anda telah berhasil dibuat.\nAnda akan diarahkan untuk melengkapi profil.",
          type: "success",
          buttons: [
            {
              text: "Lengkapi Profil",
              onClick: () => router.push(`/setprofile/${newUserId}`),
            },
          ],
        ...
        setModalState({
          ...
          title: "Error Sistem",
          message:
            "Terjadi kesalahan internal saat mendaftar.\nSilakan coba lagi nanti.",
          type: "error",
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setModalState({
      ...
      buttons: [
        {
          text: "Saya Mau Cek Lagi",
          onClick: closeGenericModal,
          className:
            "bg-gray-200 text-gray-700 hover:bg-gray-300 focus:ring-gray-400",
        },
        {
          text: "Iya, Saya Yakin & Daftar",
          onClick: () => {
        ...
        <div className="hidden lg:flex w-1/2 flex-col items-center justify-center bg-gradient-to-br from-emerald-500 to-teal-600 text-white p-12 relative overflow-hidden">
          ...
          <div className="text-center z-10">
            ...
            <p className="text-lg text-emerald-100 max-w-md mx-auto">
              Daftar di Lumora dan temukan peluang tak terbatas untuk berkarya
              dan berkolaborasi.
            </p>
          ...
          <div className="w-full max-w-md space-y-5 bg-white p-8 md:p-10 rounded-2xl shadow-xl">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-500 mt-1">
                Gratis dan hanya butuh beberapa langkah!
              </p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-emerald-600 h-full px-1"
                  >
                    {showPassword ? (
                      <EyeOffIcon size={18} />
                    ) : (
