...
const SellerStorePage = () => {
  ...
  const [sortBy, setSortBy] = useState<
    "default" | "price-asc" | "price-desc" | "newest" | "rating"
  >("default");
      ...
      try {
        ...
        if (foundSeller) {
          ...
          setModalState({
            ...
            message: "Penjual dengan ID ini tidak ditemukan.",
            type: "error",
            buttons: [{ text: "Kembali", onClick: () => router.back() }],
            onClose: () => router.back(),
          });
        }
      } catch (error) {
      ...
      <>
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
          <p className="text-gray-700">
            Penjual tidak ditemukan atau ada masalah data.
          </p>
        </div>
      </>
    );
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8">
              ...
              <div className="text-center sm:text-left flex-grow">
                ...
                <p className="text-md text-gray-600 leading-relaxed max-w-xl mx-auto sm:mx-0">
                  {seller.bio ||
                    "Penjual ini belum mengisi bio. Jelajahi karyanya di bawah!"}
                </p>
              ...
              <div className="relative">
                ...
                {showFilterDropdown && (
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border z-10 py-1">
                    <p className="px-4 py-2 text-xs text-gray-500 uppercase font-semibold border-b">
                      Filter Kategori
                    </p>
                    <button
                      onClick={() => {
                    ...
                    <p className="px-4 py-2 text-xs text-gray-500 uppercase font-semibold border-t mt-2">
                      Urutkan Berdasarkan
                    </p>
                    <button
                      onClick={() => {
          ...
          {filteredAndSortedProducts.length > 0 ? (
                  ...
                  <div className="relative w-full h-48 cursor-pointer overflow-hidden">
                    ...
                    <div className="absolute top-2 right-2">
                      <button
                        ...
                        className="p-1.5 bg-white/70 backdrop-blur-sm rounded-full text-gray-500 hover:text-pink-500 hover:bg-pink-100/80 transition-colors"
                      >
            ...
            <div className="text-center py-16 bg-white rounded-xl shadow-md border">
              <h3 className="text-xl font-semibold text-gray-800 mb-2">
                {seller.storeName || seller.fullName || seller.username} belum
                memiliki produk yang sesuai filter.
              </h3>
