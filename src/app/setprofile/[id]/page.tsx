...
const SetProfilePage = () => {
    ...
    if (userId) {
      ...
      if (storedUsers) {
        try {
          ...
          if (foundUser) {
            ...
            setModalState({
              ...
              message: "Tidak dapat memuat data untuk pengaturan profil.",
              type: "error",
              buttons: [
                {
                  text: "Ke Registrasi",
        ...
        setModalState({
          ...
          message: "Tidak ada data pengguna terdaftar.",
          type: "error",
          buttons: [
            {
              text: "Ke Registrasi",
  ...
  const handleSaveProfile = async () => {
    ...
    let finalProfilePictureUrl: string | undefined | null =
      ...
      try {
        ...
        if (!response.ok) {
          ...
          setModalState({
            isOpen: true,
            title: "Upload Gagal",
            message: `Gagal unggah foto profil. Server: ${response.status}.`,
            type: "error",
            buttons: [{ text: "OK", onClick: closeGenericModal }],
            onClose: closeGenericModal,
          });
        ...
        if (!contentType || !contentType.includes("application/json")) {
          ...
          console.error(
            "API Non-JSON (SetProfilePage):",
            responseText.substring(0, 300),
          );
          setModalState({
            isOpen: true,
            title: "Respons API Salah",
            message: `Format respons dari server upload tidak benar.`,
            type: "error",
            buttons: [{ text: "OK", onClick: closeGenericModal }],
            onClose: closeGenericModal,
          });
        ...
        if (uploadResult.fileUrl) {
          ...
          throw new Error(
            uploadResult.error || "URL file tidak ditemukan dari API.",
          );
        }
      } catch (error: any) {
        setModalState({
    ...
    if (storedUsers && initialUserData.username && initialUserData.email) {
      try {
        ...
        if (userToUpdateIndex !== -1) {
          ...
          setModalState({
            ...
            message: "Selamat datang di Lumora! Akun Anda sudah siap.",
            type: "success",
            buttons: [
              {
                text: "Mulai Jelajahi",
          ...
          setModalState({
            ...
            message: "Gagal menemukan pengguna untuk diperbarui.",
            type: "error",
            buttons: [{ text: "OK", onClick: closeGenericModal }],
            onClose: closeGenericModal,
          });
      ...
      setModalState({
        isOpen: true,
        title: "Kesalahan Data Internal",
        message: "Data pengguna awal tidak lengkap.",
        type: "error",
        buttons: [{ text: "OK", onClick: closeGenericModal }],
        onClose: closeGenericModal,
      });
  ...
  if (!initialUserData.username) {
    /* Jika data awal tidak termuat (sudah dihandle modal) */ return null;
  }
        ...
        <div className="hidden lg:flex w-1/2 flex-col items-center justify-center bg-gradient-to-br from-teal-500 to-cyan-600 text-white p-12 relative overflow-hidden">
          ...
          <div className="text-center z-10">
            ...
            <p className="text-lg text-teal-100 max-w-md mx-auto">
              Lengkapi profil Anda untuk pengalaman terbaik di Lumora. Tunjukkan
              siapa Anda kepada dunia!
            </p>
          ...
          <div className="w-full max-w-lg space-y-5 bg-white p-8 md:p-10 rounded-2xl shadow-xl">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-500 mt-1">
                Informasi ini akan membantu orang lain mengenal Anda.
              </p>
            </div>
            ...
            <div className="p-3.5 bg-gray-100 rounded-lg border border-gray-200 text-sm space-y-1">
              <div className="flex items-center">
                ...
                <span
                  className="font-medium text-gray-800 ml-1 truncate"
                  title={initialUserData.username}
                >
                  ...
                  <div className="flex-grow w-full sm:w-auto">
                    ...
                    {selectedFile && (
                      <button
                        ...
                        className="text-xs text-red-500 hover:text-red-700 mt-1.5 text-left w-full sm:w-auto"
                      >
                        {" "}
            ...
            <p className="text-center text-sm text-gray-500 mt-8">
              ...
              <span className="block text-xs mt-1">
                (Anda bisa melengkapi profil kapan saja)
              </span>
            </p>
          </div>
        </div>
