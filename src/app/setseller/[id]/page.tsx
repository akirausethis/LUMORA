...
const SetSellerProfilePage = () => {
    ...
    if (storedUser) {
      ...
      if (user.id !== userId || user.role === "seller") {
        ...
        showToast(
          "warning",
          "Akses Tidak Sesuai",
          "Anda sudah terdaftar sebagai penjual atau ini bukan akun Anda.",
        );
        router.push("/");
        return;
      }
  ...
  const handleBecomeSeller = () => {
    ...
    if (!sellerData.agreeToTerms) {
      showToast(
        "error",
        "Validasi Gagal",
        "Anda harus menyetujui Syarat & Ketentuan Penjual.",
      );
      setIsSaving(false);
      return;
    }
    ...
    try {
      ...
      if (storedUsers) {
        ...
        if (userIndex !== -1) {
          ...
          showToast(
            "success",
            "Pendaftaran Penjual Berhasil!",
            `Selamat datang, Penjual ${updatedUser.username}!`,
          );
      ...
      showToast(
        "error",
        "Kesalahan Sistem",
        "Gagal memproses pendaftaran penjual.",
      );
    } finally {
      setIsSaving(false);
    }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        ...
        <p className="ml-3 text-gray-700">
          Memuat halaman pendaftaran penjual...
        </p>
      </div>
    );
  }
  ...
  if (!currentUserData) {
    // Seharusnya sudah di-handle redirect di useEffect
    return null;
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-teal-50 to-sky-100 p-4 selection:bg-emerald-500 selection:text-white">
      <div className="bg-white p-8 md:p-10 rounded-2xl shadow-2xl w-full max-w-lg transform transition-all hover:scale-[1.01] duration-300">
        <Link
          href="/"
          className="absolute top-6 left-6 text-gray-500 hover:text-emerald-600 transition-colors md:hidden"
        >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 tracking-tight">
            Menjadi Penjual di Lumora
          </h1>
          <p className="text-gray-500 mt-2">
            Lengkapi informasi berikut untuk mulai menjual jasa Anda.
          </p>
        </div>
        ...
        >
          <div>
            ...
            >
              Nama Toko/Jasa Anda <span className="text-red-500">*</span>
            </label>
          ...
          <div>
            <label
              ...
              className="block text-sm font-medium text-gray-700 mb-1"
            >
              Deskripsi Singkat Toko/Jasa Anda (Opsional)
            </label>
            <div className="relative">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">
              Demi keamanan, di aplikasi nyata info ini akan diverifikasi.
            </p>
          </div>
          ...
          <div className="flex items-start mt-6">
            ...
            <div className="ml-3 text-sm">
              ...
              >
                ...
                Lumora. <span className="text-red-500">*</span>
              </label>
            </div>
          </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-8">
          ...
          <Link
            href="/"
            className="font-medium text-gray-600 hover:text-emerald-700 hover:underline"
          >
            Kembali ke Beranda
          </Link>
        </p>
