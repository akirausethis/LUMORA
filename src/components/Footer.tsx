...
const Footer = () => {
  return (
    <footer className="py-20 px-6 md:px-10 lg:px-20 xl:px-32 2xl:px-64 bg-gradient-to-b from-white to-green-50 text-sm text-gray-700 border-t border-green-100">
      {/* TOP */}
