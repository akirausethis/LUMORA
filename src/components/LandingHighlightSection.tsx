...
const highlightsData = [
  {
    ...
    description:
      "Terhubung dengan klien dan freelancer dari berbagai belahan dunia.",
  ...
  },
  {
    ...
    description:
      "Bergabunglah dengan ribuan talenta kreatif yang saling mendukung.",
  ...
  },
  {
    ...
    description:
      "Temukan proyek-proyek menarik yang sesuai dengan keahlian Anda.",
    ...
    <section data-aos="fade-up" className="py-16 md:py-24">
      <div className="container mx-auto px-6 md:px-12 text-center">
        ...
        <p className="text-md text-gray-600 max-w-2xl mx-auto mb-12 leading-relaxed">
          Lumora tidak hanya sekadar platform, tetapi ekosistem yang dirancang
          untuk pertumbuhan karir dan kesuksesan proyek Anda.
        </p>
        ...
        <div className="mt-12">
          ...
          <Link
            href="/register"
            className="px-8 py-3 bg-emerald-500 text-white text-lg font-semibold rounded-lg shadow-md hover:bg-emerald-600 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
          >
