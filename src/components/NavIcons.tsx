...
const NavIcons = () => {
  ...
  const confirmLogout = () => {
    ...
    setLogoutModalState({
      ...
      message:
        "Anda telah keluar dari akun. Anda akan diarahkan ke halaman registrasi.",
      type: "success",
      buttons: [
        {
          text: "OK",
  ...
  return (
    <>
      ...
      <NotificationModal
        ...
        icon={
          <StoreIcon className="w-12 h-12 text-emerald-500 mx-auto mb-4 p-2 bg-emerald-100 rounded-full" />
        }
      />
      ...
      <div className="flex items-center gap-3 sm:gap-4 xl:gap-5 relative">
        ...
        {currentUser ? (
            ...
            style={{
              background:
                currentUser.role === "seller"
                  ...
                  : "linear-gradient(to right, #6CB5AF, #5A9E97)",
            }}
          >
            {" "}
            {/* Warna disesuaikan */}
          ...
          <button
            ...
            className="hidden md:flex items-center gap-1.5 mr-1 text-white font-medium px-3 py-1.5 rounded-lg shadow hover:shadow-md transition-all text-xs sm:text-sm"
            style={{
              background: "linear-gradient(to right, #6CB5AF, #5A9E97)",
            }}
          >
            <StoreIcon className="w-4 h-4" />
            Mulai Berjualan!
            ...
            <div className="absolute p-2 rounded-lg top-full mt-2 right-0 min-w-[220px] bg-white text-sm shadow-xl border border-gray-100 z-20">
              ...
              <ul className="space-y-0.5">
                {currentUser.role === "seller" && (
                  <li>
                    ...
                    <Link
                      ...
                      className="flex items-center gap-2.5 px-3 py-2.5 hover:bg-gray-100 rounded-md text-gray-700 transition-colors"
                    >
                      {" "}
                      <StoreIcon className="w-5 h-5 text-gray-500" /> Toko
                      Saya{" "}
                    </Link>{" "}
                  </li>
                )}
                <li>
                  ...
                  >
                    {" "}
                    <Edit3Icon className="w-5 h-5 text-gray-500" /> Edit
                    Profile{" "}
                  </Link>{" "}
                </li>
                <li>
                  ...
                  <button
                    ...
                    className="w-full text-left flex items-center gap-2.5 px-3 py-2.5 hover:bg-red-50 rounded-md text-red-600 transition-colors"
                  >
                    {" "}
