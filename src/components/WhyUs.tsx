...
import {
  ...
  HeadsetIcon,
  ZapIcon,
} from "lucide-react"; // Menggunakan ikon dari Lucide React
  ...
  const reasons = [
    {
      ...
      description:
        "Kami memastikan setiap freelancer memiliki portofolio yang jelas dan reputasi yang baik untuk kualitas dan keandalan terbaik.",
    ...
    },
    {
      ...
      description:
        "Alur pencarian, pemesanan, hingga pembayaran dirancang agar intuitif, hemat waktu, dan transparan bagi kedua belah pihak.",
      bgColor: "bg-teal-50",
    ...
    },
    {
      ...
      description:
        "Tim support kami selalu siap sedia membantu Anda mengatasi kendala atau menjawab pertanyaan kapan saja dibutuhkan.",
      bgColor: "bg-sky-50",
    ...
    >
      <div className="container mx-auto px-6 md:px-12 text-center">
        ...
        <p className="text-md sm:text-lg text-gray-600 max-w-3xl mx-auto mb-12 md:mb-16 leading-relaxed">
          Kami berkomitmen untuk menyediakan platform freelance terbaik yang
          memberdayakan talenta kreatif dan memudahkan klien mendapatkan hasil
          berkualitas.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {reasons.map((item, index) => (
            ...
            >
              <div
                className={`p-5 rounded-full ${item.iconBgColor} mb-6 shadow-md inline-block transform group-hover:scale-110 transition-transform`}
              >
                {item.icon}
              </div>
